...
{
    public class CellModelRenderProcessor<CellModelComponent, CellRenderMesh> : GameEntityProcessor<CellModelComponent, RenderModel>, IEntityComponentRenderProcessor where CellModelComponent : ModelComponent where CellRenderMesh : RenderMesh, new()
    {
        private Material fallbackMaterial;

        public Dictionary<CellModelComponent, RenderModel> RenderModels => ComponentDatas;
        ...
        public VisibilityGroup VisibilityGroup 
        {
            ...
            set
            {
                visibilityGroup = value;
            }
        }

        public CellModelRenderProcessor() : base(typeof(TransformComponent))
        {
        }
        ...
        /// <inheritdoc />
        protected override RenderModel GenerateComponentData(Entity entity, CellModelComponent component)
        {
            return new RenderModel();
        }

        /// <inheritdoc />
        protected override bool IsAssociatedDataValid(Entity entity, CellModelComponent component, RenderModel associatedData)
        {
            return true;
        }

        /// <inheritdoc />
        protected override void OnEntityComponentRemoved(Entity entity, CellModelComponent component, RenderModel renderModel)
        {
        ...
        private void UpdateRenderModel(CellModelComponent modelComponent, RenderModel renderModel)
        {
        ...
        protected virtual void UpdateMaterial(CellRenderMesh renderMesh, MaterialPass materialPass, MaterialInstance modelMaterialInstance, CellModelComponent modelComponent)
        {
        ...
        private void CheckMeshes(CellModelComponent modelComponent, RenderModel renderModel)
        {
                ...
                if (model != null)
                {
                    ...
                    if (modelComponent.Enabled)
                    {
                        ...
                        for (int sourceMeshIndex = 0; sourceMeshIndex < model.Meshes.Count; sourceMeshIndex++)
                        {
                            ...
                            {
                                UpdateMaterial(renderModel.Meshes[meshIndex] as CellRenderMesh, newMaterial?.Passes[pass], model.Materials.GetItemOrNull(materialIndex), modelComponent);
                            }
                        }
                    }
                }
        ...
        RegenerateMeshes:
            ...
            var renderMeshes = new CellRenderMesh[materialMeshCount];
            for (int sourceMeshIndex = 0; sourceMeshIndex < model.Meshes.Count; sourceMeshIndex++)
            {
                ...
                for (int pass = 0; pass < material.MeshCount; ++pass, ++meshIndex)
                {
                    ...
                    renderMeshes[meshIndex] = new CellRenderMesh
                    {
